...
let favoriteFoods = ['tacos', 'curry', 'hamburger']
console.log('Just some of my favorite foods:', favoriteFoods)

// Array.length: A property that tells you how many items are in a given array.
console.log('--- 2. Length of an array ---');
console.log(Array.length, favoriteFoods)
...
console.log('Added icecream to my favorite foods...of course!');
...
let entree = 'filet Minion'
favoriteFoods.unshift(entree)
console.log('Added filet Minion to my favorites');
console.table(favoriteFoods)
...
console.log('removed the last color added', lastColor);
...
console.log('removed the first color from list', firstColor)
console.table(colors)
...
let replacedGem = gems[1]
let tourmaline = 'Tourmaline'
gems[1] = tourmaline//well that didn't work, it didn't replace Citrine but it did add Tourmaline.
//correction, it did work I just mistakenly used '2' instead of '1' replacing Diamond instead.
console.log('replaced second gem with Tourmaline', replacedGem)
console.table(gems) 
